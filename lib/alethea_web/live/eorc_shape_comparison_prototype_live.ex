defmodule AletheaWeb.EorcShapeComparisonPrototypeLive do
  ...
  defp safety_header(assigns) do
    ...
    <header class="esc-header">
      ...
      <div class="esc-statuses" aria-label="Estado del prototipo">
        <span class="esc-badge esc-badge--draft">Borrador provisional · no es un diagnóstico</span>
    ...
    <section class="esc-sources" aria-label="Notas clínicas de origen compartidas">
      ...
      <div class="esc-sources__grid">
        <article id="esc-source-1" class="esc-source">
          <div class="esc-source__meta"><span>Nota clínica inmutable</span><time>12 jun</time></div>
          
          <p>El informe escolar registró evitación antes de la presentación y
            una solicitud posterior para salir del aula.</p>
           <a href="#esc-excerpt-1">Ver extracto citado inmutable ↓</a>
        </article>
        
        <article id="esc-source-2" class="esc-source">
          <div class="esc-source__meta"><span>Nota clínica inmutable</span><time>19 jun</time></div>
          
          <p>El paciente describió haber permanecido en el grupo pese a la
            aprensión durante una actividad comparable.</p>
  ...
  defp flat_draft(assigns) do
    ...
    <section class="esc-draft esc-draft--flat" aria-labelledby="flat-title">
      ...
      <p class="esc-draft__sub">Estructura actual: tres nodos, sin sub-secciones.</p>
      ...
      <ol class="esc-chain">
        ...
        <li>
          ...
          <span>Evitación registrada en una fuente; participación en otra</span>
        </li>
        
        <li>
          <strong>Posible consecuencia</strong>
          <span>La reducción a corto plazo de la exposición sigue siendo una
            hipótesis, no una conclusión</span>
        </li>
      </ol>
      
      <div class="esc-warning">
        <strong>Contradicción no resuelta</strong>
        <p>Dos fuentes inmutables describen respuestas diferentes ante
          situaciones comparables. No las reduzca a una única decisión clínica.</p>
      </div>
    </section>
    """
  end
  ...
  defp expanded_draft(assigns) do
    ...
    <section class="esc-draft esc-draft--expanded" aria-labelledby="expanded-title">
      ...
      <p class="esc-draft__sub">Estructura propuesta: cada componente diferenciado en sub-canales
        confirmables por separado.</p>
      ...
      <article class="esc-section">
        ...
        <ol class="esc-subchain">
          <li><strong>Distal</strong> <span>Historia escolar repetida de presentaciones orales con
              respuesta de evitación documentada en informe 12 jun.</span></li>
          
          <li><strong>Inmediato</strong> <span>Aviso de evaluación oral el día previo (implícito en el
              informe; no hay nota clínica específica que lo registre).</span></li>
        </ol>
      </article>
      ...
      <article class="esc-section">
        ...
        <ol class="esc-subchain">
          ...
          <li>
            ...
            <span>Múltiples instancias previas con patrón de evitación
              (informe 12 jun).</span>
          </li>
        </ol>
      </article>
      ...
      <article class="esc-section">
        ...
        <ol class="esc-subchain">
          <li>
            ...
            <span class="esc-gap">Taquicardia observable — no explicitada en el material
              disponible; inferencia clínica pendiente de corroborar.</span>
          </li>
          
          <li>
            <strong>Cognitiva</strong>
            <span class="esc-gap">Verbalización de autoeficacia negativa — no citada
              directamente en el material disponible.</span>
          </li>
          
          <li><strong>Motora</strong> <span>12 jun: solicitud de salir del aula. 19 jun: permanencia
              en el grupo pese a la aprensión.</span></li>
        </ol>
      </article>
      ...
      <article class="esc-section">
        ...
        <ol class="esc-subchain">
          <li><strong>Corto plazo</strong> <span>Salida del aula → eliminación inmediata de la demanda
              aversiva (12 jun).</span></li>
          
          <li>
            <strong>Largo plazo</strong>
            <span class="esc-gap">Pérdida de exposición sostenida — formulada como hipótesis,
              no como conclusión; requiere notas adicionales.</span>
          </li>
        </ol>
      </article>
      ...
      <div class="esc-warning">
        <strong>Contradicción no resuelta</strong>
        <p>Dos fuentes inmutables describen respuestas motoras diferentes
          ante situaciones comparables. La estructura expandida las hace
          visibles como sub-canal motor, no como una única respuesta mixta.</p>
      </div>
    </section>
    """
  end
    ...
    <section class="esc-citations" aria-label="Extractos citados inmutables compartidos">
      ...
      <div class="esc-citations__grid">
        <article id="esc-excerpt-1" class="esc-citation">
          ...
          <p><a href="#esc-source-1">Nota clínica de origen · 12 jun</a> ·
            Informe escolar, párrafo 3</p>
        </article>
        ...
        <article id="esc-excerpt-2" class="esc-citation">
          ...
          <p><a href="#esc-source-2">Nota clínica de origen · 19 jun</a> ·
            Observación de consulta, párrafo 2</p>
        </article>
      </div>
    </section>
    """
    ...
    >
      ...
      <ul class="esc-gap-list">
        <li>
          ...
          <span>La cadena plana mezcla las tres respuestas en un único nodo
            "respuesta observada"; la expandida las separa y muestra que
            la fisiológica y la cognitiva no están citadas en el material.</span>
        </li>
        
        <li>
          <strong>Antecedente distal vs inmediato</strong>
          <span>La plana colapsa ambos en "situación"; la expandida muestra
            que el antecedente inmediato no tiene nota clínica propia que
            lo registre de manera explícita.</span>
        </li>
        
        <li>
          <strong>Variables del organismo (sueño, dolor, hambre)</strong>
          <span>No aparecen en la plana. La expandida las lista explícitamente
            como huecos que la próxima consulta podría cubrir.</span>
        </li>
        
        <li>
          <strong>Consecuencia de corto plazo vs largo plazo</strong>
          <span>La plana las mezcla como "una hipótesis"; la expandida las
            separa, dejando el largo plazo explícitamente como hipótesis
            no confirmada.</span>
        </li>
      </ul>
      
      <p class="esc-gap-panel__safety">Estos huecos son información clínica faltante, no fallas del
        modelo. La IA no los completa automáticamente; quedan a criterio
        del Profesional Responsable.</p>
    </section>
    """
  end
  ...
  def render(assigns) do
    ...
    <div id="eorc-shape-comparison-prototype" class="esc-page">
      <.safety_header /> <.shared_sources />
      <div class="esc-comparison"><.flat_draft /> <.expanded_draft /></div>
       <.shared_citations />
